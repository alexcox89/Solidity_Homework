...
contract DeferredEquityPlan {
    ...
    uint total_shares = 1000 wei;
    uint annual_distribution = 250 wei;
    uint fakenow = now;
    ...
    function distribute() public {
        ...
        require(unlock_time <= now,"You may not distribute shares at this time");
        
        
        
        // 2: `distributed_shares` is less than the `total_shares`
        require(distributed_shares < total_shares, "You may not distribute more than the total amount of shares");
